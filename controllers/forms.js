...
//     })
//     prueba= pruebas.gems_cems
//     const oden_gems = orden+","+prueba
    
//     fs.writeFileSync("./test.txt",oden_gems);
//     ////////////////////////
//     // var options = {
//     //     file: './test.txt',
//     //     user: 'root',
...
// const borrarAll = async (req,res = express.response)=>{ //res = express.response
//     try{
//         await Produccions.deleteMany({})
//         await Calidads.deleteMany({})
//         await Pruebas.deleteMany({})
//         await TecnicalTests.deleteMany({})
//         res.status(201).json({
//             ok:true,
//             msg:'ordenes borrada',
//         })
...
// // const inserQSL = async (req, res) => {
// //  insert(db,(result)=>{
// //      res.json(result);
// //    });
// //  function insert(db, callback) {                                                                                                                                                     
// //   var insertar = "INSERT INTO tabla (mfg_num,prod_line,model,area,country,customer,rev,shpdate,status,percent ) VALUES ('" + orden + "','" + null + "','" + null + "','" + null + "','" + null + "','" + null + "','" + null + "','" + null + "','" + null + "','" + null + "'); ";
  
// // var insertar = "INSERT INTO data (mfg_num) VALUES ('" + orden + "'); ";
// //   db.query(insertar, function (err, result) {
// //     if (err) throw err;
// //     callback(result);
// //   })
// //  } 
